...
| Dosya | Link |
|---|---|
| `.deb` | [**melody_2.2.48_amd64.deb indir**](https://github.com/Arise1881/melody-dist/releases/download/melody-latest/melody_2.2.48_amd64.deb) |
...
```bash
sudo apt install ./melody_2.2.48_amd64.deb   # menüde "Melody" görünür
# veya
